...
import MedicalOCRAnalyzer from '@/components/MedicalOCRAnalyzer';
...
export default function HealthCheckPage() {
  ...
  const [activeTab, setActiveTab] = useState<'prediction' | 'ocr'>('prediction');
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                ...
                <motion.div
                  ...
                  className="hidden lg:block w-16 h-16 bg-white/10 rounded-full flex items-center justify-center"
                >
